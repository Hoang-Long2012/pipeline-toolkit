...
Open an issue in the [GitHub repository](https://github.com/Hoang-Long2012/pipeline-toolkit/issues). For a bug, include a short reproduction, what you expected to happen, what happened instead, and your Python version.
...
The repository uses Python 3.14 for development. The package itself supports Python 3.8 and newer.
...
If you change dependencies, regenerate `uv.lock` with `uv lock` and include the updated lockfile. Do not edit the lockfile by hand.
